...
#if OOPS_TARGET_IS_PS5
/* Stubs for the gnm backend when the build targets prospero or trinity (OOPS_TARGET_IS_PS5), so code that calls gnm_*
 * directly still links without that backend compiled in. Weak on purpose: OOPS_SDK_C_SRCS
 * lists every backend, so a consumer following it compiles src/gnm/gnm_display.c alongside
 * this file, and the real definitions there must win rather than collide. */
__attribute__((weak)) gnm_display_t *gnm_display_open(unsigned int width, unsigned int height) {
    (void)width; (void)height;
    return (gnm_display_t *)0;
}
__attribute__((weak)) int gnm_display_is_ready(const gnm_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) uint32_t *gnm_display_get_framebuffer(gnm_display_t *disp) { (void)disp; return (uint32_t *)0; }
__attribute__((weak)) unsigned int gnm_display_get_width(const gnm_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) unsigned int gnm_display_get_height(const gnm_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) uint64_t gnm_display_get_flip_count(const gnm_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) int gnm_display_get_last_error(const gnm_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) int gnm_display_get_video_handle(const gnm_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) void gnm_display_clear(gnm_display_t *disp, uint32_t color) { (void)disp; (void)color; }
__attribute__((weak)) int gnm_display_flip(gnm_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) int gnm_display_set_flip_rate(gnm_display_t *disp, unsigned int rate) { (void)disp; (void)rate; return -1; }
__attribute__((weak)) void gnm_display_close(gnm_display_t *disp) { (void)disp; }
#else
/* Stubs for the agc backend when the build targets orbis or neo (OOPS_TARGET_IS_PS4), weak for the same
 * reason: a consumer that compiles src/agc/agc_display.c as well gets the real backend. */
__attribute__((weak)) void agc_display_set_logger(agc_log_fn fn) { (void)fn; }
__attribute__((weak)) agc_display_t *agc_display_open(unsigned int width, unsigned int height) {
    (void)width; (void)height;
    return (agc_display_t *)0;
}
__attribute__((weak)) int agc_display_is_ready(const agc_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) uint32_t *agc_display_get_framebuffer(agc_display_t *disp) { (void)disp; return (uint32_t *)0; }
__attribute__((weak)) unsigned int agc_display_get_width(const agc_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) unsigned int agc_display_get_height(const agc_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) uint64_t agc_display_get_flip_count(const agc_display_t *disp) { (void)disp; return 0; }
__attribute__((weak)) int agc_display_get_last_error(const agc_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) int agc_display_get_video_handle(const agc_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) void agc_display_clear(agc_display_t *disp, uint32_t color) { (void)disp; (void)color; }
__attribute__((weak)) int agc_display_flip(agc_display_t *disp) { (void)disp; return -1; }
__attribute__((weak)) void agc_display_close(agc_display_t *disp) { (void)disp; }
#endif
