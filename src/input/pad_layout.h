...
_Static_assert(offsetof(ScePadDataInternal, rightStick) == 6,
               "rightStick at 6");
_Static_assert(offsetof(ScePadDataInternal, analogButtons) == 8,
               "analogButtons at 8");
...
_Static_assert(offsetof(ScePadDataInternal, touchData) == 52,
               "touchData at 52");
_Static_assert(offsetof(ScePadDataInternal, connected) == 76,
               "connected at 76");
_Static_assert(offsetof(ScePadDataInternal, timestamp) == 80,
               "timestamp at 80");
