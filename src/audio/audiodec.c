 ...
 */
__attribute__((weak)) int sceAudiodecCreateDecoder(const void *ctrl,
                                                   int codec_type);
__attribute__((weak)) int sceAudiodecDeleteDecoder(int handle);
__attribute__((weak)) int sceAudiodecDecode(int handle, void *au_info,
                                            void *pcm_item);
...
__attribute__((weak)) int sceAjmModuleRegister(void *context, int codec,
                                               int64_t reserved);
__attribute__((weak)) int sceAjmInstanceCreate(void *context, int codec,
                                               uint64_t flags,
                                               void *instance_out);
...
int oops_audiodec_last_error(void) { return s_last_error; }
