...
- **[USER_GUIDE.md](USER_GUIDE.md)** - Step-by-step developer tutorial covering Makefile setup, display scanning, DualSense polling, OpenGL 1.3 3D graphics, PCM audio, JIT compilation, and privilege escalation.
