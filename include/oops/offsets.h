...
/**
 * Returns a pointer to the firmware offsets for the specified firmware version (raw BCD/hex),
 * or NULL if unsupported.
 */
const oops_fw_offsets_t *oops_offsets_get_fw(uint32_t fw_raw);

/**
 * Returns a pointer to the firmware offsets for the specified firmware version string
 * (e.g. "04.03"), or NULL if unsupported.
 */
