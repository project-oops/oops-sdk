...
/**
 * Initialize the application and package installer utility service (libSceAppInstUtil).
...
/**
 * Initiate asynchronous background installation of a PKG file from a local filesystem path.
 * Returns 0 on success, or a negative error code.
 */
