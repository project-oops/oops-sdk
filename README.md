...
| **[Controller & Input](docs/API_REFERENCE.md#7-controller--input-devices-oopsinputh-oopskeyboardh-oopsmouseh)** | `<oops/input.h>` | `oops_input_init`, `poll`, `set_rumble` | DualSense controller polling (buttons, analog sticks, adaptive triggers, haptics), keyboard & mouse |
