...
static void test_dns_parse_response(void) {
  ...
  /* Header (12 bytes) */
  pkt[pos++] = 0x50; pkt[pos++] = 0x53; /* ID = 0x5053 */
  pkt[pos++] = 0x81; pkt[pos++] = 0x80; /* Flags: QR=1, RD=1, RA=1, RCODE=0 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x01; /* QDCOUNT = 1 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x01; /* ANCOUNT = 1 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x00; /* NSCOUNT = 0 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x00; /* ARCOUNT = 0 */

  /* Question: example.com, Type 1, Class 1 */
  pkt[pos++] = 7;
  memcpy(&pkt[pos], "example", 7); pos += 7;
  pkt[pos++] = 3;
  memcpy(&pkt[pos], "com", 3); pos += 3;
  pkt[pos++] = 0;
  ...
  pkt[pos++] = 0xC0; pkt[pos++] = 0x0C; /* Name pointer to offset 12 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x01; /* TYPE = A */
  pkt[pos++] = 0x00; pkt[pos++] = 0x01; /* CLASS = IN */
  pkt[pos++] = 0x00; pkt[pos++] = 0x00; pkt[pos++] = 0x01; pkt[pos++] = 0x2C; /* TTL = 300 */
  pkt[pos++] = 0x00; pkt[pos++] = 0x04; /* RDLENGTH = 4 */
  pkt[pos++] = 93; pkt[pos++] = 184; pkt[pos++] = 216; pkt[pos++] = 34; /* 93.184.216.34 */
