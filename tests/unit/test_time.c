...
/* The nanosecond and microsecond clocks share an origin: a nanosecond reading taken after a
 * microsecond one, divided by 1000, is never behind it and never far ahead. */
