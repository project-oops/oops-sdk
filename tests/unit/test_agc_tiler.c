...
static void test_tiler_swizzle_golden(void) {
  ...
  static const struct {
    uint32_t x, y, offset;
      ...
      {0, 0, 0},         {1, 0, 1},     {2, 0, 2},
      {4, 0, 32},        {8, 0, 64},    {16, 0, 2176},
      {32, 0, 512},      {64, 0, 8448}, {0, 1, 4},
      {0, 2, 8},         {0, 4, 16},    {0, 8, 1088},
...
static void test_tiler_tile_placement(void) {
  check_placement(256, 128, 128, 0,
                  16384); /* second tile of the first tile row */
  check_placement(128, 256, 0, 128,
                  16384); /* first tile of the second tile row */
...
static void test_tiler_bijection_128x128(void) { check_bijection(128, 128); }
