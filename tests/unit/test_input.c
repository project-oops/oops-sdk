...
static void test_input_trigger_contract(void) {
  ...
  ASSERT_EQ(oops_input_set_trigger_effect(99, OOPS_TRIGGER_L2,
                                          OOPS_TRIGGER_FEEDBACK, 0, 0, 0, 0),
            -1); /* bad port */
  ASSERT_EQ(
      oops_input_set_trigger_effect(0, 0, OOPS_TRIGGER_FEEDBACK, 0, 0, 0, 0),
      -1); /* empty trigger mask */
  ASSERT_EQ(oops_input_set_trigger_effect(0, OOPS_TRIGGER_L2, 99, 0, 0, 0, 0),
            -1); /* bad mode */
  ASSERT_EQ(oops_input_set_trigger_effect(
                0, OOPS_TRIGGER_L2, OOPS_TRIGGER_FEEDBACK, 128, 255, 200, 0),
            -1); /* valid args, gated */
}
...
static void test_input_record_mapping(void) {
  ...
  oops_pad_state_t st;
  ASSERT_EQ(sizeof(ScePadDataInternal),
            OOPS_PAD_RECORD_BYTES); /* the measured 120 */
