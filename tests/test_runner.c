...
__attribute__((weak)) uint32_t *oops_display_get_framebuffer(oops_display_t *disp) { (void)disp; return NULL; }
__attribute__((weak)) unsigned int oops_display_get_width(const oops_display_t *disp) { (void)disp; return 1920; }
__attribute__((weak)) unsigned int oops_display_get_height(const oops_display_t *disp) { (void)disp; return 1080; }
...
int main(int argc, char **argv) {
    ...
    printf("\n=======================================================\n");
    printf(" TEST SUMMARY: %d Ran | \033[32m%d Passed\033[0m | \033[%sm%d Failed\033[0m\n",
           g_tests_run, g_tests_passed,
           g_tests_failed > 0 ? "31" : "32", g_tests_failed);
    printf("=======================================================\n\n");
