.text
// The textured pixel shader's sampling: whole-quad mode for the sample's implicit derivatives,
// the texture coordinate divided by its q per fragment, and the sample itself with the level of
// detail the hardware derives - not image_sample_lz's level zero, which ignores the mip chain,
// the minification filter and GL 1.4's LOD bias.
//
...
// q: the texture parameter's w, which the vertex fills.
